...
## simulate a large dataset with a lot of P 
...
for(functionsandparameters in 1){
  ##############################################################
  #*#*#*#*#*#*#*#*#*#*#*#*#*#*##*#*#*#*#*#*#**#*#*#*##*#*#*#*#*#
  # Data generation 
  ##############################################################
...
for(i in 1:p){
  print(i)
  selected.covar = covar.set[i]
  purity_one_old = c(purity_one_old, KL(1))
  purity_one = c(purity_one, KL_lm0(1))
  purity_one2 = c(purity_one2, KL_lm0_D(1))
}

one_table = data.frame(cov = covar.set, 
                       purity = -purity_one_old,
                       purity = -purity_one, 
                       purity = - purity_one2)

save(one_table, file = 'one_table.RData')
...
selected.covar = covar.set[1:2]
purity_one_old = c(purity_one_old, optim(rep(1,2), KL))
purity_one = c(purity_one, optim(rep(1,2), KL_lm0))
purity_one2 = c(purity_one2, optim(rep(1,2), KL_lm0_D))

two_table = list(cov = covar.set, 
                       purity1 = purity_one_old,
                       purity2 = purity_one, 
                       purity3 = purity_one2)

save(two_table, file = 'two_table.RData')
...
selected.covar = covar.set[1:4]
purity_one_old = c(purity_one_old, optim(rep(1,4), KL))
purity_one = c(purity_one, optim(rep(1,4), KL_lm0))
purity_one2 = c(purity_one2, optim(rep(1,4), KL_lm0_D))

four_table = list(cov = covar.set, 
                 purity1 = purity_one_old,
                 purity2 = purity_one, 
                 purity3 = purity_one2)

save(four_table, file = 'four_table.RData')
...
selected.covar = covar.set[1:8]
purity_one_old = c(purity_one_old, optim(rep(1,8), KL))
purity_one = c(purity_one, optim(rep(1,8), KL_lm0))
purity_one2 = c(purity_one2, optim(rep(1,8), KL_lm0_D))

eight_table = list(cov = covar.set, 
                 purity1 = purity_one_old,
                 purity2 = purity_one, 
                 purity3 = purity_one2)

save(eight_table, file = 'eight_table.RData')
...
selected.covar = covar.set[1:10]
purity_one_old = c(purity_one_old, optim(rep(1,10), KL))
purity_one = c(purity_one, optim(rep(1,10), KL_lm0))
purity_one2 = c(purity_one2, optim(rep(1,10), KL_lm0_D))

ten_table = list(cov = covar.set, 
                   purity1 = purity_one_old,
                   purity2 = purity_one, 
                   purity3 = purity_one2)

save(ten_table, file = 'ten_table.RData')


multi_table = rbind(c(two_table$purity2$value,
  four_table$purity2$value,
  eight_table$purity2$value,
  ten_table$purity2$value),c(two_table$purity3$value,
  four_table$purity3$value,
  eight_table$purity3$value,
  ten_table$purity3$value))

rownames(multi_table) = c('Two D', 'One D')
colnames(multi_table) = c('Two Cov','Four Cov','Eight Cov','Ten Cov')

multi_table = - round(multi_table,2)

O_t = one_table[,c(1,3,4)]
O_t[,2:3] = round(O_t[,2:3], 2)
colnames(O_t) = c('Covariate name', 'Purity with 2D', 'Purity with 1D')
rownames(O_t) = NULL

multi = list(multi_table = multi_table, O_t = O_t)
